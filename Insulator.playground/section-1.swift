...
let calculator = Calculator(currentBloodGlucoseLevel: 12.3, carbohydratesInMeal: 60)
calculator.getCarbohydrateDose(false)
calculator.getCorrectiveDose(false)
calculator.getSuggestedDose(true)
